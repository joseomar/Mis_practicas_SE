;******************************************************************************
;Practica 10: WatchDog timer
;
;El mismo ejemplo anterior, pero con el uso de watchdog
;
...
; CONFIG2H
  ...
  CONFIG  WDTPS = 32	        ; Watchdog Timer Postscale Select bits (1:32768)
...
Inicio:
	...
	movwf	Delay2
	bsf	WDTCON,SWDTEN	; Prendo el watchdog (solo tiene efecto con el bit de configuracion en OFF)
...
Retardo1:
	...
	goto      Retardo1       ; Cada loop toma 3 ciclos de maquina * 256 loops= 768 instrucciones
	decfsz    Delay2,f       ; Comienza el retardo, Decremento Delay1 hasta llegar a cero
	goto      Retardo1       ; Cada loop toma 3 ciclos de maquina * 256 loops= 768 instrucciones
	goto	principal
